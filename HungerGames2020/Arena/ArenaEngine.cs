...
namespace Arena
{
    abstract public class ArenaEngine
    {
        static public Random Random { get { return DongUtility.ThreadSafeRandom.Random(); } }
        ...
        public GraphicTurnSet TurnSet { get; private set; } = new GraphicTurnSet(0);
        ...
        public GraphicTurnSet CurrentTurn
        {
            get => TurnSet;
        }
        ...
        public void AddObject(ArenaObject obj, Vector2D location)
        {
            ...
            {
                UpdatingObjects.Add((MovingObject)obj);
            }
            else
            {
            ...
            grid.AddObject(obj);
#endif
            TurnSet.AddTurn(new AddObject(obj));
        }
        ...
        public bool MoveObject(ArenaObject obj, Vector2D target)
        {
            ...
            else
            {
                ...
                TurnSet.AddTurn(new MoveObject(obj, target));
                return true;
            }
        }
        ...
        {
            Time = newTime;
            TurnSet = new GraphicTurnSet(Time);
