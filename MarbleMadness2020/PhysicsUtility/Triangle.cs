...
namespace PhysicsUtility
{
    ...
    public class Triangle
    {
        ...
        public Vector Intersection(Vector initialPoint, Vector finalPoint)
        {
            ...
            Vector rotatedIntersection = GetRotatedIntersection(rotatedInitial, rotatedFinal);
            return TransformFromZ(rotatedIntersection);
        }
        ...
        private Vector GetRotatedIntersection(Vector rotatedInitial, Vector rotatedFinal)
        {
            ...
            return new Vector(xslope * zDiff + rotatedInitial.X, yslope * zDiff + rotatedInitial.Y, 0);
        }
